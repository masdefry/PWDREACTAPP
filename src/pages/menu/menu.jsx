...
export default function Menu(){
    ...
    //         let response = await axios.get('https://my-json-server.typicode.com/masdefry/pwdjsonserver/products')
    //         let responseCategory = await axios.get('https://my-json-server.typicode.com/masdefry/pwdjsonserver/category')
    ...
    let onGetData = async() => {
        try {
            let response = await axios.get('https://my-json-server.typicode.com/masdefry/pwdjsonserver/products?category=0')
            let responseCategory = await axios.get('https://my-json-server.typicode.com/masdefry/pwdjsonserver/category')
    ...
    let onFilter = async(idx) => {
        let response = await axios.get(`https://my-json-server.typicode.com/masdefry/pwdjsonserver/products?category=${idx}`)
